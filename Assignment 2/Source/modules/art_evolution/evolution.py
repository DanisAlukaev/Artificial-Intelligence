...
from config import IMAGE_SIZE, POPULATION_SIZE, GENERATIONS_NUMBER, FILE_NAME, ELITE_SIZE, MUTATIONS_NUMBER
...
def run_evolution(use_palette=False):
    ...
    population = Population(POPULATION_SIZE, ELITE_SIZE, MUTATIONS_NUMBER, use_palette)
